...
export default function Home() {
  ...
  <div className="landing_content grid max-md:grid-cols-1 grid-cols-3 gap-1.5">
          ...
          <button className='mt-1.5 lg:hidden bg-gray-600 py-2 rounded-sm col-span-2 flex items-center justify-center gap-2' onClick={()=>setShowCalculator(!showCalculator)}>
            <svg className='w-4 fill-gray-200' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M64 0C28.7 0 0 28.7 0 64L0 448c0 35.3 28.7 64 64 64l256 0c35.3 0 64-28.7 64-64l0-384c0-35.3-28.7-64-64-64L64 0zM96 64l192 0c17.7 0 32 14.3 32 32l0 32c0 17.7-14.3 32-32 32L96 160c-17.7 0-32-14.3-32-32l0-32c0-17.7 14.3-32 32-32zm32 160a32 32 0 1 1 -64 0 32 32 0 1 1 64 0zM96 352a32 32 0 1 1 0-64 32 32 0 1 1 0 64zM64 416c0-17.7 14.3-32 32-32l96 0c17.7 0 32 14.3 32 32s-14.3 32-32 32l-96 0c-17.7 0-32-14.3-32-32zM192 256a32 32 0 1 1 0-64 32 32 0 1 1 0 64zm32 64a32 32 0 1 1 -64 0 32 32 0 1 1 64 0zm64-64a32 32 0 1 1 0-64 32 32 0 1 1 0 64zm32 64a32 32 0 1 1 -64 0 32 32 0 1 1 64 0zM288 448a32 32 0 1 1 0-64 32 32 0 1 1 0 64z"/></svg>
            <span className='text-center text-lg text-gray-200'>{showCalculator ? 'Hide Calculator' : 'Calculator'}</span>
          </button>

          <div className={`border border-gray-200 rounded hidden lg:block ${showCalculator && '!block'}`}>
            <LandingCalculator/>
          </div>
  </div>
          
  <div className="section !-mt-1.5">
